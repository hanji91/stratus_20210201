...
#ifndef _LINEAR_DEQUANT_TYPE_WRAP_INCLUDED_
#define _LINEAR_DEQUANT_TYPE_WRAP_INCLUDED_


#include <systemc.h>
#include "linear_dequant.h"


// Declaration of wrapper with RTL level ports

SC_MODULE(linear_dequant_type_wrapper)
{
public:
	...
	SC_HAS_PROCESS(linear_dequant_type_wrapper);

	linear_dequant_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("linear_dequant")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
