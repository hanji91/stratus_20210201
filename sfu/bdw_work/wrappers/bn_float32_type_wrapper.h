...
#ifndef _BN_FLOAT32_TYPE_WRAP_INCLUDED_
#define _BN_FLOAT32_TYPE_WRAP_INCLUDED_


#include <systemc.h>
#include "bn_float32.h"


// Declaration of wrapper with RTL level ports

SC_MODULE(bn_float32_type_wrapper)
{
public:
	...
	SC_HAS_PROCESS(bn_float32_type_wrapper);

	bn_float32_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("bn_float32")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
