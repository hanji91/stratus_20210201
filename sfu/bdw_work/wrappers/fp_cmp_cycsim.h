...
#ifndef _FP_CMP_CYCSIM_INCLUDED_
#define _FP_CMP_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(fp_cmp_cycsim)
{
	...
	fp_cmp_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" fp_cmp") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
