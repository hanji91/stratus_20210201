...
#ifndef _LEARN_CLIP_TYPE_WRAP_INCLUDED_
#define _LEARN_CLIP_TYPE_WRAP_INCLUDED_


#include <systemc.h>
#include "learn_clip.h"


// Declaration of wrapper with RTL level ports

SC_MODULE(learn_clip_type_wrapper)
{
public:
	...
	SC_HAS_PROCESS(learn_clip_type_wrapper);

	learn_clip_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("learn_clip")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
