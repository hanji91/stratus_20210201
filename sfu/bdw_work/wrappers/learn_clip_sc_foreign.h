...
#ifndef _LEARN_CLIP_SC_FOREIGN_INCLUDED_
#define _LEARN_CLIP_SC_FOREIGN_INCLUDED_
...
struct learn_clip : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "learn_clip"; }
    
	learn_clip( sc_module_name name )
...
#endif /* _LEARN_CLIP_SC_FOREIGN_INCLUDED_ */
