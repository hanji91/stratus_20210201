...
#ifndef _FP_MUL_SC_FOREIGN_INCLUDED_
#define _FP_MUL_SC_FOREIGN_INCLUDED_
...
struct fp_mul : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "fp_mul"; }
...
#endif /* _FP_MUL_SC_FOREIGN_INCLUDED_ */
