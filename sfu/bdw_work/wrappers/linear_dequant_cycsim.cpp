...
#include "verilated.h"
#include "Vlinear_dequant_rtl.h"


class Vlinear_dequant_rtl;

class linear_dequant_cycsimV : public linear_dequant_cycsim
{
    ...
    sc_signal< uint32_t > divisor_man_I;
    sc_signal< uint32_t > divisor_exp_I;
    sc_signal< bool > divisor_sign_I;
    ...
    inline void thread_divisor_man_I() {
        divisor_man_I = (sc_uint<23>)divisor_man.read();
    };
    inline void thread_divisor_exp_I() {
        divisor_exp_I = (sc_uint<8>)divisor_exp.read();
    };
    inline void thread_divisor_sign_I() {
        divisor_sign_I = (sc_uint<1>)divisor_sign.read();
    };
    ...
    SC_HAS_PROCESS(linear_dequant_cycsimV);

public:

    linear_dequant_cycsimV( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" linear_dequant") ) )
        : linear_dequant_cycsim(in_name)
    {
        // instantiate the verilated module
        linear_dequant_cyc0 = new Vlinear_dequant_rtl( "Vlinear_dequant" );
        // generate port connections
        linear_dequant_cyc0->clk(clk);
        linear_dequant_cyc0->rstn(rstn);
        linear_dequant_cyc0->enable(enable);
        linear_dequant_cyc0->src_valid(src_valid);
        linear_dequant_cyc0->src_man_0(src_man_0_I);
        linear_dequant_cyc0->src_exp_0(src_exp_0_I);
        linear_dequant_cyc0->src_sign_0(src_sign_0_I);
        linear_dequant_cyc0->src_man_1(src_man_1_I);
        linear_dequant_cyc0->src_exp_1(src_exp_1_I);
        linear_dequant_cyc0->src_sign_1(src_sign_1_I);
        linear_dequant_cyc0->src_man_2(src_man_2_I);
        linear_dequant_cyc0->src_exp_2(src_exp_2_I);
        linear_dequant_cyc0->src_sign_2(src_sign_2_I);
        linear_dequant_cyc0->src_man_3(src_man_3_I);
        linear_dequant_cyc0->src_exp_3(src_exp_3_I);
        linear_dequant_cyc0->src_sign_3(src_sign_3_I);
        linear_dequant_cyc0->src_man_4(src_man_4_I);
        linear_dequant_cyc0->src_exp_4(src_exp_4_I);
        linear_dequant_cyc0->src_sign_4(src_sign_4_I);
        linear_dequant_cyc0->src_man_5(src_man_5_I);
        linear_dequant_cyc0->src_exp_5(src_exp_5_I);
        linear_dequant_cyc0->src_sign_5(src_sign_5_I);
        linear_dequant_cyc0->src_man_6(src_man_6_I);
        linear_dequant_cyc0->src_exp_6(src_exp_6_I);
        linear_dequant_cyc0->src_sign_6(src_sign_6_I);
        linear_dequant_cyc0->src_man_7(src_man_7_I);
        linear_dequant_cyc0->src_exp_7(src_exp_7_I);
        linear_dequant_cyc0->src_sign_7(src_sign_7_I);
        linear_dequant_cyc0->divisor_man(divisor_man_I);
        linear_dequant_cyc0->divisor_exp(divisor_exp_I);
        linear_dequant_cyc0->divisor_sign(divisor_sign_I);
        linear_dequant_cyc0->dst_valid(dst_valid);
        linear_dequant_cyc0->dst_man_0(dst_man_0_O);
        linear_dequant_cyc0->dst_exp_0(dst_exp_0_O);
        linear_dequant_cyc0->dst_sign_0(dst_sign_0_O);
        linear_dequant_cyc0->dst_man_1(dst_man_1_O);
        linear_dequant_cyc0->dst_exp_1(dst_exp_1_O);
        linear_dequant_cyc0->dst_sign_1(dst_sign_1_O);
        linear_dequant_cyc0->dst_man_2(dst_man_2_O);
        linear_dequant_cyc0->dst_exp_2(dst_exp_2_O);
        linear_dequant_cyc0->dst_sign_2(dst_sign_2_O);
        linear_dequant_cyc0->dst_man_3(dst_man_3_O);
        linear_dequant_cyc0->dst_exp_3(dst_exp_3_O);
        linear_dequant_cyc0->dst_sign_3(dst_sign_3_O);
        linear_dequant_cyc0->dst_man_4(dst_man_4_O);
        linear_dequant_cyc0->dst_exp_4(dst_exp_4_O);
        linear_dequant_cyc0->dst_sign_4(dst_sign_4_O);
        linear_dequant_cyc0->dst_man_5(dst_man_5_O);
        linear_dequant_cyc0->dst_exp_5(dst_exp_5_O);
        linear_dequant_cyc0->dst_sign_5(dst_sign_5_O);
        linear_dequant_cyc0->dst_man_6(dst_man_6_O);
        linear_dequant_cyc0->dst_exp_6(dst_exp_6_O);
        linear_dequant_cyc0->dst_sign_6(dst_sign_6_O);
        linear_dequant_cyc0->dst_man_7(dst_man_7_O);
        linear_dequant_cyc0->dst_exp_7(dst_exp_7_O);
        linear_dequant_cyc0->dst_sign_7(dst_sign_7_O);
        ...
        SC_METHOD( thread_divisor_man_I);
            sensitive << divisor_man;
        SC_METHOD( thread_divisor_exp_I);
            sensitive << divisor_exp;
        SC_METHOD( thread_divisor_sign_I);
        ...
        if ( tfp )
        {
            linear_dequant_cyc0->trace(tfp,99);
        }
    };

    ~linear_dequant_cycsimV()
    {
        delete linear_dequant_cyc0;
    }
...
protected:
    Vlinear_dequant_rtl* linear_dequant_cyc0;
};

linear_dequant_cycsim* linear_dequant_cycsim_factory()
{
    return new linear_dequant_cycsimV("linear_dequant");
}

class linear_dequant_linkup
{
public:
    linear_dequant_linkup() {
        extern linear_dequant_cycsim* (*linear_dequant_cycsim_factory_p)();
        linear_dequant_cycsim_factory_p = &linear_dequant_cycsim_factory;
    }
};

// Create the one instance of the factory for this verilated model.
linear_dequant_linkup linear_dequant_cycsimV_link;
