...
#ifndef _AVG_POOL_SC_FOREIGN_INCLUDED_
#define _AVG_POOL_SC_FOREIGN_INCLUDED_
...
struct avg_pool : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "avg_pool"; }
...
#endif /* _AVG_POOL_SC_FOREIGN_INCLUDED_ */
