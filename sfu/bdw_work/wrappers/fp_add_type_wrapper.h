...
#ifndef _FP_ADD_TYPE_WRAP_INCLUDED_
#define _FP_ADD_TYPE_WRAP_INCLUDED_
...
public:
	...
	SC_HAS_PROCESS(fp_add_type_wrapper);

	fp_add_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("fp_add")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,src_valid("src_valid")
