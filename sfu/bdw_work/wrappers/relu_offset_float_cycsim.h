...
#ifndef _RELU_OFFSET_FLOAT_CYCSIM_INCLUDED_
#define _RELU_OFFSET_FLOAT_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(relu_offset_float_cycsim)
{
	...
	relu_offset_float_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" relu_offset_float") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
