...
#ifndef _FP_CMP_TYPE_WRAP_INCLUDED_
#define _FP_CMP_TYPE_WRAP_INCLUDED_
...
public:
	...
	SC_HAS_PROCESS(fp_cmp_type_wrapper);

	fp_cmp_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("fp_cmp")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
