...
#ifndef _FP_DIV_SC_FOREIGN_INCLUDED_
#define _FP_DIV_SC_FOREIGN_INCLUDED_
...
struct fp_div : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "fp_div"; }
...
#endif /* _FP_DIV_SC_FOREIGN_INCLUDED_ */
