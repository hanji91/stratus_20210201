...
#ifndef _BN_FLOAT32_CYCSIM_INCLUDED_
#define _BN_FLOAT32_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(bn_float32_cycsim)
{
	...
	bn_float32_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" bn_float32") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
