...
#ifndef _FP_ADD_SC_FOREIGN_INCLUDED_
#define _FP_ADD_SC_FOREIGN_INCLUDED_
...
struct fp_add : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "fp_add"; }
...
#endif /* _FP_ADD_SC_FOREIGN_INCLUDED_ */
