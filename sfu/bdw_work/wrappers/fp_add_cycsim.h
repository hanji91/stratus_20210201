...
#ifndef _FP_ADD_CYCSIM_INCLUDED_
#define _FP_ADD_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(fp_add_cycsim)
{
	...
	fp_add_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" fp_add") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,src_valid("src_valid")
