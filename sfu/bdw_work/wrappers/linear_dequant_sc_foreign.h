...
#ifndef _LINEAR_DEQUANT_SC_FOREIGN_INCLUDED_
#define _LINEAR_DEQUANT_SC_FOREIGN_INCLUDED_
...
struct linear_dequant : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "linear_dequant"; }
...
#endif /* _LINEAR_DEQUANT_SC_FOREIGN_INCLUDED_ */
