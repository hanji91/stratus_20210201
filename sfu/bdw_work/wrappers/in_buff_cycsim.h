...
#ifndef _IN_BUFF_CYCSIM_INCLUDED_
#define _IN_BUFF_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(in_buff_cycsim)
{
	...
	in_buff_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" in_buff") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
