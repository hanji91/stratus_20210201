...
#ifndef _FLOAT_DIV_CYCSIM_INCLUDED_
#define _FLOAT_DIV_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(float_div_cycsim)
{
	...
	float_div_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" float_div") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
