...
#ifndef _RELU_OFFSET_FLOAT_SC_FOREIGN_INCLUDED_
#define _RELU_OFFSET_FLOAT_SC_FOREIGN_INCLUDED_
...
struct relu_offset_float : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "relu_offset_float"; }
...
#endif /* _RELU_OFFSET_FLOAT_SC_FOREIGN_INCLUDED_ */
