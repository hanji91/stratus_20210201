...
#ifndef _FP_DIV_CYCSIM_INCLUDED_
#define _FP_DIV_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(fp_div_cycsim)
{
	...
	fp_div_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" fp_div") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,src_valid("src_valid")
