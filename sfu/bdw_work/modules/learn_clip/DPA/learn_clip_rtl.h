...
// from learn_clip.cpp
#ifndef CYNTH_PART_learn_clip_learn_clip_rtl_h
#define CYNTH_PART_learn_clip_learn_clip_rtl_h
...
struct learn_clip : public sc_module {
  sc_in<bool > clk;
  sc_in<bool > rstn;
  sc_in<bool > enable;
  ...
  sc_signal<sc_uint<1> > learn_clip_N_Muxb_1_2_0_4_1_out1;
  ...
  sc_signal<sc_uint<23> > r1_zero_point_man;
  sc_signal<sc_uint<8> > r1_zero_point_exp;
  sc_signal<sc_uint<1> > r1_zero_point_sign;
  ...
  void learn_clip_N_Muxb_1_2_0_4_1();
  ...
  void drive_r1_zero_point_sign();
  void drive_r1_zero_point_exp();
  void drive_r1_zero_point_man();
