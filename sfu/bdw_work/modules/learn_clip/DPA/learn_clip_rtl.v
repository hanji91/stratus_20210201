...
module learn_clip(clk, rstn, enable, src_valid, src_man_0, src_man_1, src_man_2, src_man_3, src_man_4, src_man_5, src_man_6, src_man_7, src_exp_0, src_exp_1, src_exp_2, src_exp_3, src_exp_4, src_exp_5, src_exp_6, src_exp_7, src_sign_0, src_sign_1, src_sign_2, src_sign_3, src_sign_4, src_sign_5, src_sign_6, src_sign_7, scale_man, scale_exp, scale_sign, zero_point_man, zero_point_exp, zero_point_sign, dst_valid, dst_man_0, dst_man_1, dst_man_2, dst_man_3, dst_man_4, dst_man_5, dst_man_6, dst_man_7
, 
      dst_exp_0, dst_exp_1, dst_exp_2, dst_exp_3, dst_exp_4, dst_exp_5, dst_exp_6, dst_exp_7, dst_sign_0, dst_sign_1, dst_sign_2, dst_sign_3, dst_sign_4, dst_sign_5, dst_sign_6, dst_sign_7);
      ...
      output dst_sign_7;
      reg dst_sign_7;
      reg learn_clip_N_Muxb_1_2_0_4_1_out1;
      ...
      reg[22:0] r1_zero_point_man;
      reg[7:0] r1_zero_point_exp;
      reg r1_zero_point_sign;
      wire[22:0] add_result_man_7;
      wire[7:0] add_result_exp_7;
      wire add_result_sign_7;
      wire add_valid_7;

         // rtl_instance:learn_clip/u_fp_add_7
         fp_add u_fp_add_7(
                  .clk( clk ),
                  .rstn( rstn ),
                  ...
                  .b_man( r1_zero_point_man ),
                  .b_exp( r1_zero_point_exp ),
                  .b_sign( r1_zero_point_sign ),
         ...
         // rtl_instance:learn_clip/u_fp_add_6
         fp_add u_fp_add_6(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_5
         fp_add u_fp_add_5(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_4
         fp_add u_fp_add_4(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_3
         fp_add u_fp_add_3(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_2
         fp_add u_fp_add_2(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_1
         fp_add u_fp_add_1(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_add_0
         fp_add u_fp_add_0(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_7
         fp_mul u_fp_mul_7(
                  .clk( clk ),
                  .rstn( rstn ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_6
         fp_mul u_fp_mul_6(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_5
         fp_mul u_fp_mul_5(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_4
         fp_mul u_fp_mul_4(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_3
         fp_mul u_fp_mul_3(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_2
         fp_mul u_fp_mul_2(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_1
         fp_mul u_fp_mul_1(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_instance:learn_clip/u_fp_mul_0
         fp_mul u_fp_mul_0(
                  .clk( clk ),
                  .rstn( rstn ),
                  .src_valid( r_src_valid ),
         ...
         // rtl_process:learn_clip/drive_dst_valid
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_dst_valid
         // at: learn_clip.h:82:7
         // at: learn_clip.h:86:7
         always @(posedge clk or negedge rstn)
          begin :drive_dst_valid
            if (rstn == 1'b0) begin
               ...
               // op:_dst_valid/OP5
               dst_valid <= learn_clip_N_Muxb_1_2_0_4_1_out1;
            end
         end

         // rtl_instance:learn_clip/learn_clip_N_Muxb_1_2_0_4
         always @(src_valid or enable or add_valid_0)
          begin :learn_clip_N_Muxb_1_2_0_4_1
            if (enable) begin
               learn_clip_N_Muxb_1_2_0_4_1_out1 = add_valid_0;
            end
            else begin
               learn_clip_N_Muxb_1_2_0_4_1_out1 = src_valid;
            end
         end

         // rtl_process:learn_clip/drive_dst_sign_0
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_sign_7
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_0
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_exp_7
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_0
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_dst_man_7
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r1_zero_point_sign
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_r1_zero_point_sign
         // at: cynw_cm_float_int.h:409:14
         always @(posedge clk or negedge rstn)
          begin :drive_r1_zero_point_sign
            if (rstn == 1'b0) begin
               // op:_delay/OP155
               r1_zero_point_sign <= 1'b0;
            end
            else begin
               // op:_delay/OP190
               r1_zero_point_sign <= zero_point_sign;
            end
         end

         // rtl_process:learn_clip/drive_r1_zero_point_exp
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_r1_zero_point_exp
         // at: cynw_cm_float_int.h:408:14
         always @(posedge clk or negedge rstn)
          begin :drive_r1_zero_point_exp
            if (rstn == 1'b0) begin
               // op:_delay/OP156
               r1_zero_point_exp <= 8'd000;
            end
            else begin
               // op:_delay/OP189
               r1_zero_point_exp <= zero_point_exp;
            end
         end

         // rtl_process:learn_clip/drive_r1_zero_point_man
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_r1_zero_point_man
         // at: cynw_cm_float_int.h:407:14
         always @(posedge clk or negedge rstn)
          begin :drive_r1_zero_point_man
            if (rstn == 1'b0) begin
               // op:_delay/OP157
               r1_zero_point_man <= 23'd0000000;
            end
            else begin
               // op:_delay/OP188
               r1_zero_point_man <= zero_point_man;
            end
         end

         // rtl_process:learn_clip/drive_r_src_valid
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_r_src_valid
         // at: learn_clip.h:46:2
         // at: learn_clip.h:57:2
         always @(posedge clk or negedge rstn)
         ...
         // rtl_process:learn_clip/drive_r_src_sign_0
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_r_src_sign_0
         // at: learn_clip.h:41:7
         // at: learn_clip.h:52:7
         always @(posedge clk or negedge rstn)
         ...
         // rtl_process:learn_clip/drive_r_src_sign_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_sign_7
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_0
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_exp_7
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_0
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_1
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_2
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_3
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_4
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_5
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_6
         // Sharing or Control mux
         ...
         // rtl_process:learn_clip/drive_r_src_man_7
         // Sharing or Control mux
