...
module fix2float(clk, rstn, enable, fraction_len, src_valid, src, dst_valid, dst);
      ...
      reg fix2float_N_Muxb_1_2_9_4_1_out1;
         ...
         always @(posedge clk or negedge rstn)
          begin :drive_dst_valid
            if (rstn == 1'b0) begin
               ...
               // op:_dst_valid/OP5
               dst_valid <= fix2float_N_Muxb_1_2_9_4_1_out1;
            end
         end

         // rtl_instance:fix2float/fix2float_N_Muxb_1_2_9_4
         always @(src_valid or enable or src_valid_3d)
          begin :fix2float_N_Muxb_1_2_9_4_1
            if (enable) begin
               fix2float_N_Muxb_1_2_9_4_1_out1 = src_valid_3d;
            end
            else begin
               fix2float_N_Muxb_1_2_9_4_1_out1 = src_valid;
            end
         end
         ...
         always @(posedge clk or negedge rstn)
          begin :drive_dst
            if (rstn == 1'b0) begin
               ...
               // op:_dst/OP23
               dst <= fix2float_N_Mux_32_2_51_4_6_out1;
            end
         end
         ...
         // Implements 1 operation(s)
         // at: fix2float.h:226:15
         assign fix2float_And_1Ux1U_1U_4_3_out1 = fix2float_Not_1U_1U_4_2_out1 & src_valid_3d;

         // rtl_instance:fix2float/fix2float_Add_8Ux8U_8U_4_4
         // Resource=fix2float_Add_8Ux8U_8U_4, Function=add : Inputs=8,8 Outputs=8
         // Implements 1 operation(s)
         // at: fix2float.h:231:62
         assign fix2float_Add_8Ux8U_8U_4_4_out1 = {{ 2 {r_z_e_slice[5]}}, r_z_e_slice} + r_fraction_len;

         // rtl_process:fix2float/drive_fix2float_N_Mux_32_2_49_4_5_in2
         // Sharing or Control mux
         // Sharing/Controlling 1 operation(s) on drive_fix2float_N_Mux_32_2_49_4_5_in2
         // at: fix2float.h:231:86
         assign fix2float_N_Mux_32_2_49_4_5_in2 = {{r_z_s, fix2float_Add_8Ux8U_8U_4_4_out1}, r_z_m};

         // rtl_instance:fix2float/fix2float_N_Mux_32_2_49_4
         always @(fix2float_And_1Ux1U_1U_4_3_out1 or fix2float_N_Mux_32_2_49_4_5_in2)
          begin :fix2float_N_Mux_32_2_49_4_5
            if (fix2float_And_1Ux1U_1U_4_3_out1) begin
               fix2float_N_Mux_32_2_49_4_5_out1 = fix2float_N_Mux_32_2_49_4_5_in2;
            end
            else begin
               fix2float_N_Mux_32_2_49_4_5_out1 = 32'd0000000000;
            end
         end

         // rtl_instance:fix2float/fix2float_N_Mux_32_2_51_4
         always @(src or enable or fix2float_N_Mux_32_2_49_4_5_out1)
          begin :fix2float_N_Mux_32_2_51_4_6
            if (enable) begin
               fix2float_N_Mux_32_2_51_4_6_out1 = fix2float_N_Mux_32_2_49_4_5_out1;
            end
            else begin
               fix2float_N_Mux_32_2_51_4_6_out1 = src;
            end
         end
         ...
         always @(posedge clk or negedge rstn)
          begin :drive_r2_in_data
            if (rstn == 1'b0) begin
               // op:_r2_in_data/OP256
               r2_in_data <= 32'd0000000000;
            end
            else begin
               // op:_r2_in_data/OP265
         ...
         always @(posedge clk or negedge rstn)
          begin :drive_r_in_data
            if (rstn == 1'b0) begin
               // op:_r_in_data_sign/OP41
               r_in_data <= 32'd0000000000;
            end
            else begin
               // op:_r_in_data_sign/OP59
         ...
         always @(posedge clk or negedge rstn)
          begin :drive_r_sign
            if (rstn == 1'b0) begin
               // op:_r_in_data_sign/OP42
               r_sign <= 1'd0;
            end
            else begin
               // op:_r_in_data_sign/OP53
