...
#ifndef cynw_cm_float_mul_ieee_E8_M23_COMPILED
#define cynw_cm_float_mul_ieee_E8_M23_COMPILED

SC_MODULE(cynw_cm_float_mul_ieee_E8_M23) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_0(1): inst_cellmath__37__40(7,0)
    sc_signal<sc_uint<8> > lhs_part_0;
    void method_57() {
        lhs_part_0 = sc_uint<8>(
    ...
    // part assign: lhs_part_1(1): inst_cellmath__53(22,22)
    ...
    // part assign: lhs_part_2(2): inst_cellmath__53(21,0)
    sc_signal<sc_uint<22> > lhs_part_2;
    void method_63() {
        lhs_part_2 = sc_uint<22>(
    ...
    void method_66() { 
        ...
        temp_66(7,0) = lhs_part_0.read();
        inst_cellmath__37__40 = temp_66;
}
    void method_67() { 
        sc_uint<23> temp_67 = inst_cellmath__53.read();
        temp_67(22,22) = lhs_part_1.read();
        temp_67(21,0) = lhs_part_2.read();
        inst_cellmath__53 = temp_67;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(cynw_cm_float_mul_ieee_E8_M23)
#   if defined(CYNTHVLG)
    ;
#      else
    {
...
#endif //  #ifndef cynw_cm_float_mul_ieee_E8_M23_COMPILED

/* CADENCE  uLX0SQ7cog== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
