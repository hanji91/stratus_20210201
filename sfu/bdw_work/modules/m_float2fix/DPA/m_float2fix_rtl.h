...
#ifndef CYNTH_PART_m_float2fix_m_float2fix_rtl_h
#define CYNTH_PART_m_float2fix_m_float2fix_rtl_h
...
#endif
#include "bdw_work/wrappers/float2fix_wrap.h"
#else
...
struct m_float2fix : public sc_module {
  sc_in<bool > clk;
  sc_in<bool > rstn;
  ...
  sc_signal<bool > m_dst_valid_0;
  sc_signal<bool > m_dst_valid_1;
  sc_signal<bool > m_dst_valid_2;
  sc_signal<bool > m_dst_valid_3;
  sc_signal<bool > m_dst_valid_4;
  sc_signal<bool > m_dst_valid_5;
  sc_signal<bool > m_dst_valid_6;
  sc_signal<bool > m_dst_valid_7;
