...
#ifndef float_div_cynw_cm_float_mul_ieee_E8_M23_3_COMPILED
#define float_div_cynw_cm_float_mul_ieee_E8_M23_3_COMPILED

SC_MODULE(float_div_cynw_cm_float_mul_ieee_E8_M23_3) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_285(1): inst_cellmath__37__40(7,0)
    sc_signal<sc_uint<8> > lhs_part_285;
    void method_57() {
        lhs_part_285 = sc_uint<8>(
    ...
    // part assign: lhs_part_286(1): inst_cellmath__53(22,22)
    sc_signal<sc_uint<1> > lhs_part_286;
    void method_61() {
        lhs_part_286 = sc_uint<1>(
    ...
    // part assign: lhs_part_287(2): inst_cellmath__53(21,0)
    sc_signal<sc_uint<22> > lhs_part_287;
    void method_63() {
        lhs_part_287 = sc_uint<22>(
    ...
    void method_66() { 
        ...
        temp_66(7,0) = lhs_part_285.read();
        inst_cellmath__37__40 = temp_66;
}
    void method_67() { 
        sc_uint<23> temp_67 = inst_cellmath__53.read();
        temp_67(22,22) = lhs_part_286.read();
        temp_67(21,0) = lhs_part_287.read();
        inst_cellmath__53 = temp_67;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(float_div_cynw_cm_float_mul_ieee_E8_M23_3)
#   if defined(CYNTHVLG)
    ;
#      else
    {
...
#endif //  #ifndef float_div_cynw_cm_float_mul_ieee_E8_M23_3_COMPILED

/* CADENCE  uLX0TQDXqQ== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
