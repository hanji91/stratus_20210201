...
struct class_fp_add_cynw_cm_float_add2_ieee_E8_M23_3 { // BDW_REPLACE_NAME cynw_cm_float_add2_ieee
...
inline void fp_add_cynw_cm_float_add2_ieee_E8_M23_3( // module fp_add_cynw_cm_float_add2_ieee_E8_M23_3
    const sc_uint<1>& a_sign // input  a_sign : unsigned
    ,const sc_uint<8>& a_exp // input  a_exp[7:0] : unsigned
    ,const sc_uint<23>& a_man // input  a_man[22:0] : unsigned
    ,const sc_uint<1>& b_sign // input  b_sign : unsigned
...
{
    static class_fp_add_cynw_cm_float_add2_ieee_E8_M23_3 target; // BDW_REPLACE_NAME
    target(
        a_sign,
        a_exp,
        a_man,
