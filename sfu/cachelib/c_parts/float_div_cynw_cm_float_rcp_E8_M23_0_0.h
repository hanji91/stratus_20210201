...
#ifndef float_div_cynw_cm_float_rcp_E8_M23_0_0_COMPILED
#define float_div_cynw_cm_float_rcp_E8_M23_0_0_COMPILED

SC_MODULE(float_div_cynw_cm_float_rcp_E8_M23_0_0) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_0(1): x(32,32)
    sc_signal<sc_uint<1> > lhs_part_0;
    void method_0() {
        lhs_part_0 = sc_uint<1>(
    ...
    // part assign: lhs_part_1(1): inst_mult_d_cellmath__49__72(0,0)
    sc_signal<sc_uint<1> > lhs_part_1;
    void method_23() {
        lhs_part_1 = sc_uint<1>(
    ...
    // part assign: lhs_part_2(1): inst_mult_d_cellmath__49__71(0,0)
    sc_signal<sc_uint<1> > lhs_part_2;
    void method_24() {
        lhs_part_2 = sc_uint<1>(
    ...
    // part assign: lhs_part_3(1): inst_mult_d_cellmath__49__67(0,0)
    sc_signal<sc_uint<1> > lhs_part_3;
    void method_26() {
        lhs_part_3 = sc_uint<1>(
    ...
    // part assign: lhs_part_4(1): inst_mult_d_cellmath__49__66(0,0)
    sc_signal<sc_uint<1> > lhs_part_4;
    void method_27() {
        lhs_part_4 = sc_uint<1>(
    ...
    // part assign: lhs_part_5(1): inst_mult_d_cellmath__49__62(0,0)
    sc_signal<sc_uint<1> > lhs_part_5;
    void method_30() {
        lhs_part_5 = sc_uint<1>(
    ...
    // part assign: lhs_part_6(1): inst_mult_d_cellmath__49__61(0,0)
    sc_signal<sc_uint<1> > lhs_part_6;
    void method_31() {
        lhs_part_6 = sc_uint<1>(
    ...
    // part assign: lhs_part_7(1): inst_mult_d_cellmath__49__57(0,0)
    sc_signal<sc_uint<1> > lhs_part_7;
    void method_34() {
        lhs_part_7 = sc_uint<1>(
    ...
    // part assign: lhs_part_8(1): inst_mult_d_cellmath__49__56(0,0)
    sc_signal<sc_uint<1> > lhs_part_8;
    void method_35() {
        lhs_part_8 = sc_uint<1>(
    ...
    // part assign: lhs_part_9(1): inst_mult_d_cellmath__49__52(0,0)
    ...
    // part assign: lhs_part_10(1): inst_mult_d_cellmath__49__51(0,0)
    ...
    // part assign: lhs_part_11(1): inst_mult_d_cellmath__49__47(0,0)
    sc_signal<sc_uint<1> > lhs_part_11;
    void method_42() {
        lhs_part_11 = sc_uint<1>(
    ...
    // part assign: lhs_part_12(1): inst_mult_d_cellmath__49__46(0,0)
    ...
    // part assign: lhs_part_13(1): inst_mult_d_cellmath__49__42(0,0)
    sc_signal<sc_uint<1> > lhs_part_13;
    void method_46() {
        lhs_part_13 = sc_uint<1>(
    ...
    // part assign: lhs_part_14(1): inst_mult_d_cellmath__49__41(0,0)
    sc_signal<sc_uint<1> > lhs_part_14;
    void method_47() {
        lhs_part_14 = sc_uint<1>(
    ...
    // part assign: lhs_part_15(1): inst_mult_d_cellmath__49__37(0,0)
    ...
    // part assign: lhs_part_16(1): inst_mult_d_cellmath__49__36(0,0)
    sc_signal<sc_uint<1> > lhs_part_16;
    void method_51() {
        lhs_part_16 = sc_uint<1>(
    ...
    // part assign: lhs_part_17(1): inst_mult_d_cellmath__49__32(0,0)
    sc_signal<sc_uint<1> > lhs_part_17;
    void method_54() {
        lhs_part_17 = sc_uint<1>(
    ...
    // part assign: lhs_part_18(1): inst_mult_d_cellmath__49__31(0,0)
    sc_signal<sc_uint<1> > lhs_part_18;
    void method_55() {
        lhs_part_18 = sc_uint<1>(
    ...
    // part assign: lhs_part_19(1): inst_mult_d_cellmath__49__27(0,0)
    ...
    // part assign: lhs_part_20(1): inst_mult_d_cellmath__49__26(0,0)
    ...
    // part assign: lhs_part_21(1): inst_mult_d_cellmath__49__17(0,0)
    ...
    // part assign: lhs_part_22(1): inst_mult_d_cellmath__49__16(0,0)
    sc_signal<sc_uint<1> > lhs_part_22;
    void method_63() {
        lhs_part_22 = sc_uint<1>(
    ...
    // part assign: lhs_part_23(1): inst_mult_d_cellmath__49__22(0,0)
    sc_signal<sc_uint<1> > lhs_part_23;
    void method_66() {
        lhs_part_23 = sc_uint<1>(
    ...
    // part assign: lhs_part_24(1): inst_mult_d_cellmath__49__21(0,0)
    ...
    // part assign: lhs_part_25(1): inst_mult_d_cellmath__49(24,0)
    sc_signal<sc_uint<25> > lhs_part_25;
    void method_82() {
        lhs_part_25 = sc_uint<25>(
    ...
    // part assign: lhs_part_26(1): inst_FP_RECIP_MULT_C_mult_c_datapath_prodSum(21,0)
    sc_signal<sc_uint<22> > lhs_part_26;
    void method_84() {
        lhs_part_26 = sc_uint<22>(
    ...
    // part assign: lhs_part_27(1): inst_FP_RECIP_MULT_B_mult_b_datapath_prodSum(33,0)
    sc_signal<sc_uint<34> > lhs_part_27;
    void method_87() {
        lhs_part_27 = sc_uint<34>(
    ...
    // part assign: lhs_part_28(2): x(31,0)
    sc_signal<sc_uint<32> > lhs_part_28;
    void method_93() {
        lhs_part_28 = sc_uint<32>(
    ...
    void method_122() { 
        ...
        temp_122(33,0) = lhs_part_27.read();
        inst_FP_RECIP_MULT_B_mult_b_datapath_prodSum = temp_122;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(float_div_cynw_cm_float_rcp_E8_M23_0_0)
#   if defined(CYNTHVLG)
    ;
#      else
    {
...
#endif //  #ifndef float_div_cynw_cm_float_rcp_E8_M23_0_0_COMPILED

/* CADENCE  vLD0QwnZrw== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
