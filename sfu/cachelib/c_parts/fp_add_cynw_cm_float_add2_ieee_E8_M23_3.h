...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_91(1): inst_cellmath__26(23,0)
    sc_signal<sc_uint<24> > lhs_part_91;
    void method_0() {
        lhs_part_91 = sc_uint<24>(
    ...
    // part assign: lhs_part_92(1): inst_cellmath__28__8(8,0)
    sc_signal<sc_uint<9> > lhs_part_92;
    void method_19() {
        lhs_part_92 = sc_uint<9>(
    ...
    // part assign: lhs_part_93(1): inst_cellmath__28(8,8)
    ...
    // part assign: lhs_part_94(1): inst_cellmath__33(49,24)
    sc_signal<sc_uint<26> > lhs_part_94;
    void method_33() {
        lhs_part_94 = sc_uint<26>(
    ...
    // part assign: lhs_part_95(1): inst_cellmath__25(23,0)
    sc_signal<sc_uint<24> > lhs_part_95;
    void method_37() {
        lhs_part_95 = sc_uint<24>(
    ...
    // part assign: lhs_part_96(1): inst_cellmath__40_0_0(23,0)
    sc_signal<sc_uint<24> > lhs_part_96;
    void method_38() {
        lhs_part_96 = sc_uint<24>(
    ...
    // part assign: lhs_part_97(1): inst_cellmath__45(25,0)
    sc_signal<sc_uint<26> > lhs_part_97;
    void method_43() {
        lhs_part_97 = sc_uint<26>(
    ...
    // part assign: lhs_part_98(1): inst_cellmath__68(0,0)
    ...
    // part assign: lhs_part_99(2): inst_cellmath__68(7,1)
    sc_signal<sc_uint<7> > lhs_part_99;
    void method_93() {
        lhs_part_99 = sc_uint<7>(
...
/* CADENCE  vrbzTQjdow== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
