...
/*****************************************************************************
    ...
    Configured at: 12:11:21 KST (+0900), Tuesday 29 December 2020
...
#ifndef float_div_cynw_cm_float_mul_ieee_E8_M23_2_0_COMPILED
#define float_div_cynw_cm_float_mul_ieee_E8_M23_2_0_COMPILED

SC_MODULE(float_div_cynw_cm_float_mul_ieee_E8_M23_2_0) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_213(1): inst_cellmath__37__40(7,0)
    sc_signal<sc_uint<8> > lhs_part_213;
    void method_57() {
        lhs_part_213 = sc_uint<8>(
    ...
    // part assign: lhs_part_214(1): inst_cellmath__53(22,22)
    sc_signal<sc_uint<1> > lhs_part_214;
    void method_61() {
        lhs_part_214 = sc_uint<1>(
    ...
    // part assign: lhs_part_215(2): inst_cellmath__53(21,0)
    sc_signal<sc_uint<22> > lhs_part_215;
    void method_63() {
        lhs_part_215 = sc_uint<22>(
    ...
    void method_66() { 
        ...
        temp_66(7,0) = lhs_part_213.read();
        inst_cellmath__37__40 = temp_66;
}
    void method_67() { 
        sc_uint<23> temp_67 = inst_cellmath__53.read();
        temp_67(22,22) = lhs_part_214.read();
        temp_67(21,0) = lhs_part_215.read();
        inst_cellmath__53 = temp_67;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(float_div_cynw_cm_float_mul_ieee_E8_M23_2_0)
#   if defined(CYNTHVLG)
    ;
#      else
    {
...
#endif //  #ifndef float_div_cynw_cm_float_mul_ieee_E8_M23_2_0_COMPILED

/* CADENCE  uLX0QgvWrg== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
