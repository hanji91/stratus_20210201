...
#if !defined cynw_cm_float_add2_ieee_E8_M23_INCLUDED
#define cynw_cm_float_add2_ieee_E8_M23_INCLUDED

struct class_cynw_cm_float_add2_ieee_E8_M23 { // BDW_REPLACE_NAME cynw_cm_float_add2_ieee
...
#endif // !defined cynw_cm_float_add2_ieee_E8_M23_INCLUDED
    // !!!! amethyst/writers/SystemCbeh.cpp:4142
// cynw_cm_float_add2_ieee - cynth invocation function


inline void cynw_cm_float_add2_ieee_E8_M23( // module cynw_cm_float_add2_ieee_E8_M23
    const sc_uint<1>& a_sign // input  a_sign : unsigned
    ,const sc_uint<8>& a_exp // input  a_exp[7:0] : unsigned
    ,const sc_uint<23>& a_man // input  a_man[22:0] : unsigned
    ,const sc_uint<1>& b_sign // input  b_sign : unsigned
...
{
    static class_cynw_cm_float_add2_ieee_E8_M23 target; // BDW_REPLACE_NAME
    target(
        a_sign,
        a_exp,
        a_man,
