...
#ifndef float_div_cynw_cm_float_rcp_E8_M23_3_COMPILED
#define float_div_cynw_cm_float_rcp_E8_M23_3_COMPILED

SC_MODULE(float_div_cynw_cm_float_rcp_E8_M23_3) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_255(1): x(32,32)
    sc_signal<sc_uint<1> > lhs_part_255;
    void method_0() {
        lhs_part_255 = sc_uint<1>(
    ...
    // part assign: lhs_part_256(1): inst_mult_d_cellmath__49__72(0,0)
    sc_signal<sc_uint<1> > lhs_part_256;
    void method_23() {
        lhs_part_256 = sc_uint<1>(
    ...
    // part assign: lhs_part_257(1): inst_mult_d_cellmath__49__71(0,0)
    sc_signal<sc_uint<1> > lhs_part_257;
    void method_24() {
        lhs_part_257 = sc_uint<1>(
    ...
    // part assign: lhs_part_258(1): inst_mult_d_cellmath__49__67(0,0)
    sc_signal<sc_uint<1> > lhs_part_258;
    void method_26() {
        lhs_part_258 = sc_uint<1>(
    ...
    // part assign: lhs_part_259(1): inst_mult_d_cellmath__49__66(0,0)
    sc_signal<sc_uint<1> > lhs_part_259;
    void method_27() {
        lhs_part_259 = sc_uint<1>(
    ...
    // part assign: lhs_part_260(1): inst_mult_d_cellmath__49__62(0,0)
    sc_signal<sc_uint<1> > lhs_part_260;
    void method_30() {
        lhs_part_260 = sc_uint<1>(
    ...
    // part assign: lhs_part_261(1): inst_mult_d_cellmath__49__61(0,0)
    ...
    // part assign: lhs_part_262(1): inst_mult_d_cellmath__49__57(0,0)
    sc_signal<sc_uint<1> > lhs_part_262;
    void method_34() {
        lhs_part_262 = sc_uint<1>(
    ...
    // part assign: lhs_part_263(1): inst_mult_d_cellmath__49__56(0,0)
    sc_signal<sc_uint<1> > lhs_part_263;
    void method_35() {
        lhs_part_263 = sc_uint<1>(
    ...
    // part assign: lhs_part_264(1): inst_mult_d_cellmath__49__52(0,0)
    sc_signal<sc_uint<1> > lhs_part_264;
    void method_38() {
        lhs_part_264 = sc_uint<1>(
    ...
    // part assign: lhs_part_265(1): inst_mult_d_cellmath__49__51(0,0)
    sc_signal<sc_uint<1> > lhs_part_265;
    void method_39() {
        lhs_part_265 = sc_uint<1>(
    ...
    // part assign: lhs_part_266(1): inst_mult_d_cellmath__49__47(0,0)
    sc_signal<sc_uint<1> > lhs_part_266;
    void method_42() {
        lhs_part_266 = sc_uint<1>(
    ...
    // part assign: lhs_part_267(1): inst_mult_d_cellmath__49__46(0,0)
    sc_signal<sc_uint<1> > lhs_part_267;
    void method_43() {
        lhs_part_267 = sc_uint<1>(
    ...
    // part assign: lhs_part_268(1): inst_mult_d_cellmath__49__42(0,0)
    sc_signal<sc_uint<1> > lhs_part_268;
    void method_46() {
        lhs_part_268 = sc_uint<1>(
    ...
    // part assign: lhs_part_269(1): inst_mult_d_cellmath__49__41(0,0)
    sc_signal<sc_uint<1> > lhs_part_269;
    void method_47() {
        lhs_part_269 = sc_uint<1>(
    ...
    // part assign: lhs_part_270(1): inst_mult_d_cellmath__49__37(0,0)
    sc_signal<sc_uint<1> > lhs_part_270;
    void method_50() {
        lhs_part_270 = sc_uint<1>(
    ...
    // part assign: lhs_part_271(1): inst_mult_d_cellmath__49__36(0,0)
    sc_signal<sc_uint<1> > lhs_part_271;
    void method_51() {
        lhs_part_271 = sc_uint<1>(
    ...
    // part assign: lhs_part_272(1): inst_mult_d_cellmath__49__32(0,0)
    sc_signal<sc_uint<1> > lhs_part_272;
    void method_54() {
        lhs_part_272 = sc_uint<1>(
    ...
    // part assign: lhs_part_273(1): inst_mult_d_cellmath__49__31(0,0)
    sc_signal<sc_uint<1> > lhs_part_273;
    void method_55() {
        lhs_part_273 = sc_uint<1>(
    ...
    // part assign: lhs_part_274(1): inst_mult_d_cellmath__49__27(0,0)
    sc_signal<sc_uint<1> > lhs_part_274;
    void method_58() {
        lhs_part_274 = sc_uint<1>(
    ...
    // part assign: lhs_part_275(1): inst_mult_d_cellmath__49__26(0,0)
    sc_signal<sc_uint<1> > lhs_part_275;
    void method_59() {
        lhs_part_275 = sc_uint<1>(
    ...
    // part assign: lhs_part_276(1): inst_mult_d_cellmath__49__17(0,0)
    sc_signal<sc_uint<1> > lhs_part_276;
    void method_62() {
        lhs_part_276 = sc_uint<1>(
    ...
    // part assign: lhs_part_277(1): inst_mult_d_cellmath__49__16(0,0)
    sc_signal<sc_uint<1> > lhs_part_277;
    void method_63() {
        lhs_part_277 = sc_uint<1>(
    ...
    // part assign: lhs_part_278(1): inst_mult_d_cellmath__49__22(0,0)
    sc_signal<sc_uint<1> > lhs_part_278;
    void method_66() {
        lhs_part_278 = sc_uint<1>(
    ...
    // part assign: lhs_part_279(1): inst_mult_d_cellmath__49__21(0,0)
    sc_signal<sc_uint<1> > lhs_part_279;
    void method_67() {
        lhs_part_279 = sc_uint<1>(
    ...
    // part assign: lhs_part_280(1): inst_mult_d_cellmath__49(24,0)
    sc_signal<sc_uint<25> > lhs_part_280;
    void method_82() {
        lhs_part_280 = sc_uint<25>(
    ...
    // part assign: lhs_part_281(1): inst_FP_RECIP_MULT_C_mult_c_datapath_prodSum(21,0)
    sc_signal<sc_uint<22> > lhs_part_281;
    void method_84() {
        lhs_part_281 = sc_uint<22>(
    ...
    // part assign: lhs_part_282(1): inst_FP_RECIP_MULT_B_mult_b_datapath_prodSum(33,0)
    sc_signal<sc_uint<34> > lhs_part_282;
    void method_87() {
        lhs_part_282 = sc_uint<34>(
    ...
    // part assign: lhs_part_283(2): x(31,0)
    sc_signal<sc_uint<32> > lhs_part_283;
    void method_93() {
        lhs_part_283 = sc_uint<32>(
    ...
    void method_122() { 
        ...
        temp_122(33,0) = lhs_part_282.read();
        inst_FP_RECIP_MULT_B_mult_b_datapath_prodSum = temp_122;
}
#     endif // !defined(CYNTHVLG)

    SC_CTOR(float_div_cynw_cm_float_rcp_E8_M23_3)
#   if defined(CYNTHVLG)
    ;
#      else
    {
    ...
    // !!!! amethyst/writers/SystemC.cpp:5668
        ...
        sensitive << lhs_part_255
                  ...
                  << lhs_part_284;
        SC_METHOD(method_96);
        sensitive << lhs_part_256;
        SC_METHOD(method_97);
        sensitive << lhs_part_257;
        SC_METHOD(method_98);
...
#endif //  #ifndef float_div_cynw_cm_float_rcp_E8_M23_3_COMPILED

/* CADENCE  vLD1SQvfow== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
