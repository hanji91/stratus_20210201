...
#ifndef fp_add_cynw_cm_float_add2_ieee_E8_M23_0_0_COMPILED
#define fp_add_cynw_cm_float_add2_ieee_E8_M23_0_0_COMPILED

SC_MODULE(fp_add_cynw_cm_float_add2_ieee_E8_M23_0_0) // architecture "behavioural"
{
...
#    if !defined(CYNTHVLG)
    ...
    // part assign: lhs_part_0(1): inst_cellmath__26(23,0)
    sc_signal<sc_uint<24> > lhs_part_0;
    void method_0() {
        lhs_part_0 = sc_uint<24>(
    ...
    // part assign: lhs_part_1(1): inst_cellmath__28__8(8,0)
    sc_signal<sc_uint<9> > lhs_part_1;
    void method_19() {
        lhs_part_1 = sc_uint<9>(
    ...
    // part assign: lhs_part_2(1): inst_cellmath__28(8,8)
    ...
    // part assign: lhs_part_3(1): inst_cellmath__33(49,24)
    sc_signal<sc_uint<26> > lhs_part_3;
    void method_33() {
        lhs_part_3 = sc_uint<26>(
    ...
    // part assign: lhs_part_4(1): inst_cellmath__25(23,0)
    ...
    // part assign: lhs_part_5(1): inst_cellmath__40_0_0(23,0)
    sc_signal<sc_uint<24> > lhs_part_5;
    void method_38() {
        lhs_part_5 = sc_uint<24>(
    ...
    // part assign: lhs_part_6(1): inst_cellmath__45(25,0)
    sc_signal<sc_uint<26> > lhs_part_6;
    void method_43() {
        lhs_part_6 = sc_uint<26>(
    ...
    // part assign: lhs_part_7(1): inst_cellmath__68(0,0)
    ...
    // part assign: lhs_part_8(2): inst_cellmath__68(7,1)
    sc_signal<sc_uint<7> > lhs_part_8;
    void method_93() {
        lhs_part_8 = sc_uint<7>(
...
#endif //  #ifndef fp_add_cynw_cm_float_add2_ieee_E8_M23_0_0_COMPILED

/* CADENCE  vrbzTADYog== : u9/ySgnWtBlWxVPRXgAZ4Og= ** DO NOT EDIT THIS LINE **/
