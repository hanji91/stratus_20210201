...
// Generated on: Dec 23 2020 16:35:30 KST (Dec 23 2020 07:35:30 UTC)

module in_buff_MuxAdd2i1u5u5u1_4_1(in3, in2, ctrl1, out1);
  input [4:0] in3, in2;
  input ctrl1;
  output [4:0] out1;
  wire [4:0] in3, in2;
  ...
  MX2XL g60(.A (n_2), .B (in3[1]), .S0 (n_0), .Y (out1[1]));
  MX2XL g61(.A (in3[3]), .B (n_4), .S0 (ctrl1), .Y (out1[3]));
  MX2XL g62(.A (n_3), .B (in3[2]), .S0 (n_0), .Y (out1[2]));
