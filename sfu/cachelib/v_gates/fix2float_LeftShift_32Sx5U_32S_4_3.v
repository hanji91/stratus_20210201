...
// Generated on: Jan  6 2021 14:47:44 KST (Jan  6 2021 05:47:44 UTC)

module fix2float_LeftShift_32Sx5U_32S_4_3(in2, in1, out1);
  input [31:0] in2;
  input [4:0] in1;
  output [31:0] out1;
  wire [31:0] in2;
  ...
  NOR2XL sll_21_21_g1680(.A (in1[3]), .B (sll_21_21_n_85), .Y
       (sll_21_21_n_111));
  ...
  NOR2BX1 sll_21_21_g1717(.AN (sll_21_21_n_57), .B (in1[4]), .Y
       (out1[0]));
  NOR2XL sll_21_21_g1718(.A (in1[3]), .B (sll_21_21_n_59), .Y
       (sll_21_21_n_73));
