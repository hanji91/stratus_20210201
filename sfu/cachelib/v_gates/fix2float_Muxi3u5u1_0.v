...
// Generated on: Dec 28 2020 13:27:14 KST (Dec 28 2020 04:27:14 UTC)

module fix2float_Muxi3u5u1_0(in2, ctrl1, out1);
  input [4:0] in2;
  input ctrl1;
  output [4:0] out1;
  wire [4:0] in2;
  wire ctrl1;
  wire [4:0] out1;
  wire n_0, n_2, n_3, n_4, n_23, n_24;
  ...
  NAND2X4 g9(.A (n_23), .B (n_24), .Y (out1[1]));
  INVX8 g12(.A (in2[1]), .Y (n_23));
