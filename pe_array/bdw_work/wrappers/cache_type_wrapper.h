...
#ifndef _CACHE_TYPE_WRAP_INCLUDED_
#define _CACHE_TYPE_WRAP_INCLUDED_
...
public:
	...
	SC_HAS_PROCESS(cache_type_wrapper);

	cache_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("cache")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,cache_en("cache_en")
