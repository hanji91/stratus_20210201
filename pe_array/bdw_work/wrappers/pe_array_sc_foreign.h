...
#ifndef _PE_ARRAY_SC_FOREIGN_INCLUDED_
#define _PE_ARRAY_SC_FOREIGN_INCLUDED_
...
struct pe_array : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "pe_array"; }
...
#endif /* _PE_ARRAY_SC_FOREIGN_INCLUDED_ */
