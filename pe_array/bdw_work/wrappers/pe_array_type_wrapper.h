...
#ifndef _PE_ARRAY_TYPE_WRAP_INCLUDED_
#define _PE_ARRAY_TYPE_WRAP_INCLUDED_
...
SC_MODULE(pe_array_type_wrapper)
{
public:
	...
	SC_HAS_PROCESS(pe_array_type_wrapper);

	pe_array_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("pe_array")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,enable("enable")
