...
#ifndef _CACHE_SC_FOREIGN_INCLUDED_
#define _CACHE_SC_FOREIGN_INCLUDED_
...
struct cache : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "cache"; }
...
#endif /* _CACHE_SC_FOREIGN_INCLUDED_ */
