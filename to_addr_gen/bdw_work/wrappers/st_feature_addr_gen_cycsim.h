...
#ifndef _ST_FEATURE_ADDR_GEN_CYCSIM_INCLUDED_
#define _ST_FEATURE_ADDR_GEN_CYCSIM_INCLUDED_

#include "systemc.h"
#include "cynthhl.h"

SC_MODULE(st_feature_addr_gen_cycsim)
{
	...
	st_feature_addr_gen_cycsim( sc_module_name in_name=sc_module_name(sc_gen_unique_name(" st_feature_addr_gen") ) )
		: sc_module(in_name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,stop("stop")
