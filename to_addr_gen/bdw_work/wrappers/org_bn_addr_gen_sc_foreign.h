...
#ifndef _ORG_BN_ADDR_GEN_SC_FOREIGN_INCLUDED_
#define _ORG_BN_ADDR_GEN_SC_FOREIGN_INCLUDED_
...
struct org_bn_addr_gen : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "org_bn_addr_gen"; }
...
#endif /* _ORG_BN_ADDR_GEN_SC_FOREIGN_INCLUDED_ */
