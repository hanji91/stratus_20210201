//
// Verilog co-simulation wrapper module for the bn_addr_gen module.
...
// by esc_link_signals calls in the proxy module found in the bn_addr_gen_cosim.h 
// file.

`timescale 1 ps / 1 ps

module bn_addr_gen_cosim;
	...
	bn_addr_gen bn_addr_gen0( .clk(clk),
	 .rstn(rstn),
	...
	// Make sure that we process delayed assignments after the clock edge.
	always @( bn_addr_gen0.rstn ) begin
	...
	// Make sure that we process delayed assignments after the clock edge.
	always @( bn_addr_gen0.data_en ) begin
