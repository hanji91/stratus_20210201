...
#ifndef _PW_WEIGHT_ADDR_GEN_WRAP_INCLUDED_
#define _PW_WEIGHT_ADDR_GEN_WRAP_INCLUDED_
...
#define pw_weight_addr_gen_wrapper pw_weight_addr_gen
...
struct pw_weight_addr_gen_cosim;
struct pw_weight_addr_gen_cycsim;
struct pw_weight_addr_gen_rtl;
...
public:
	...
	SC_HAS_PROCESS(pw_weight_addr_gen_wrapper);
		...
		: sc_module(name)
		  ...
		  ,pw_weight_addr_gen0(0), pw_weight_addr_gen_cosim0(0), pw_weight_addr_gen_rtl0(0), pw_weight_addr_gen_cycsim0(0)
    ...
    bool isBEH() { return ( pw_weight_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_Behavioral ); }
    bool isRTL_C() { return ( pw_weight_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_RTL_C ); }
    bool isRTL_V() { return ( pw_weight_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_RTL_HDL ); }
    bool isGATES_V() { return ( pw_weight_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_Gates ); }
	bool isCosim() { return ( isRTL_V() || isGATES_V() ); }
    bool isCycsim() { return ( pw_weight_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_CYC_HDL ); }

	pw_weight_addr_gen* behModule() { return pw_weight_addr_gen0; }
	pw_weight_addr_gen_cosim* cosimModule() { return pw_weight_addr_gen_cosim0; }
	pw_weight_addr_gen_cycsim* cycsimModule() { return pw_weight_addr_gen_cycsim0; }
	pw_weight_addr_gen_rtl* rtlModule() { return pw_weight_addr_gen_rtl0; }

	pw_weight_addr_gen* pw_weight_addr_gen0;
	pw_weight_addr_gen_cosim* pw_weight_addr_gen_cosim0;
	pw_weight_addr_gen_rtl* pw_weight_addr_gen_rtl0;
	pw_weight_addr_gen_cycsim* pw_weight_addr_gen_cycsim0;
};

// Declaration of wrapper with RTL level ports

SC_MODULE(pw_weight_addr_gen_wrapper_r)
{
public:
	...
	SC_HAS_PROCESS(pw_weight_addr_gen_wrapper_r);

	pw_weight_addr_gen_wrapper_r( sc_module_name name = sc_module_name( sc_gen_unique_name("pw_weight_addr_gen")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,stop("stop")
    ...
    bool isBEH() { return ( pw_weight_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_Behavioral ); }
    bool isRTL_C() { return ( pw_weight_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_RTL_C ); }
    bool isRTL_V() { return ( pw_weight_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_RTL_HDL ); }
    bool isGATES_V() { return ( pw_weight_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_Gates ); }
	bool isCosim() { return ( isRTL_V() || isGATES_V() ); }
    bool isCycsim() { return ( pw_weight_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_CYC_HDL ); }
