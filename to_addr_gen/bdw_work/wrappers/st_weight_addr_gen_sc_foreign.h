...
#ifndef _ST_WEIGHT_ADDR_GEN_SC_FOREIGN_INCLUDED_
#define _ST_WEIGHT_ADDR_GEN_SC_FOREIGN_INCLUDED_
...
struct st_weight_addr_gen : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "st_weight_addr_gen"; }
...
#endif /* _ST_WEIGHT_ADDR_GEN_SC_FOREIGN_INCLUDED_ */
