...
#ifndef _ST_FEATURE_ADDR_GEN_WRAP_INCLUDED_
#define _ST_FEATURE_ADDR_GEN_WRAP_INCLUDED_
...
#define st_feature_addr_gen_wrapper st_feature_addr_gen
...
public:
	...
	SC_HAS_PROCESS(st_feature_addr_gen);
    	st_feature_addr_gen_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("st_feature_addr_gen")) );
};
...
struct st_feature_addr_gen;
struct st_feature_addr_gen_cosim;
struct st_feature_addr_gen_cycsim;
struct st_feature_addr_gen_rtl;
...
SC_MODULE(st_feature_addr_gen_wrapper)
{
public:
	...
	SC_HAS_PROCESS(st_feature_addr_gen_wrapper);
		...
		: sc_module(name)
		  ...
		  ,st_feature_addr_gen0(0), st_feature_addr_gen_cosim0(0), st_feature_addr_gen_rtl0(0), st_feature_addr_gen_cycsim0(0)
    ...
    bool isBEH() { return ( st_feature_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_Behavioral ); }
    bool isRTL_C() { return ( st_feature_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_RTL_C ); }
    bool isRTL_V() { return ( st_feature_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_RTL_HDL ); }
    bool isGATES_V() { return ( st_feature_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_Gates ); }
	bool isCosim() { return ( isRTL_V() || isGATES_V() ); }
    bool isCycsim() { return ( st_feature_addr_gen_wrapper::lookupRepresentation( name() ) == BDWRep_CYC_HDL ); }

	st_feature_addr_gen* behModule() { return st_feature_addr_gen0; }
	st_feature_addr_gen_cosim* cosimModule() { return st_feature_addr_gen_cosim0; }
	st_feature_addr_gen_cycsim* cycsimModule() { return st_feature_addr_gen_cycsim0; }
	st_feature_addr_gen_rtl* rtlModule() { return st_feature_addr_gen_rtl0; }

	st_feature_addr_gen* st_feature_addr_gen0;
	st_feature_addr_gen_cosim* st_feature_addr_gen_cosim0;
	st_feature_addr_gen_rtl* st_feature_addr_gen_rtl0;
	st_feature_addr_gen_cycsim* st_feature_addr_gen_cycsim0;
};

// Declaration of wrapper with RTL level ports

SC_MODULE(st_feature_addr_gen_wrapper_r)
{
public:
	...
	SC_HAS_PROCESS(st_feature_addr_gen_wrapper_r);

	st_feature_addr_gen_wrapper_r( sc_module_name name = sc_module_name( sc_gen_unique_name("st_feature_addr_gen")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,stop("stop")
    ...
    bool isBEH() { return ( st_feature_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_Behavioral ); }
    bool isRTL_C() { return ( st_feature_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_RTL_C ); }
    bool isRTL_V() { return ( st_feature_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_RTL_HDL ); }
    bool isGATES_V() { return ( st_feature_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_Gates ); }
	bool isCosim() { return ( isRTL_V() || isGATES_V() ); }
    bool isCycsim() { return ( st_feature_addr_gen_wrapper_r::lookupRepresentation( name() ) == BDWRep_CYC_HDL ); }
