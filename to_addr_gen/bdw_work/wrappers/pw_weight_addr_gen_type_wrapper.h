...
#ifndef _PW_WEIGHT_ADDR_GEN_TYPE_WRAP_INCLUDED_
#define _PW_WEIGHT_ADDR_GEN_TYPE_WRAP_INCLUDED_


#include <systemc.h>
#include "pw_weight_addr_gen.h"


// Declaration of wrapper with RTL level ports

SC_MODULE(pw_weight_addr_gen_type_wrapper)
{
public:
	...
	SC_HAS_PROCESS(pw_weight_addr_gen_type_wrapper);

	pw_weight_addr_gen_type_wrapper( sc_module_name name = sc_module_name( sc_gen_unique_name("pw_weight_addr_gen")) )
		: sc_module(name)
		  ,clk("clk")
		  	,rstn("rstn")
		  	,stop("stop")
    ...
    // destructor
    ~pw_weight_addr_gen_type_wrapper()
    {
        DeleteInstances();
    }
