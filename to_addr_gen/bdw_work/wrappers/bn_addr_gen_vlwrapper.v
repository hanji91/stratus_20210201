...
/****************************************************************************
*
* Verilog Verification wrapper module for the bn_addr_gen module.
*
...
module bn_addr_gen_vlwrapper(
    ...
    bn_addr_gen_type_wrapper bn_addr_gen_sc(
        .clk(clk),
         .rstn(rstn),
...
module bn_addr_gen_type_wrapper(
      clk,
       rstn,
       out_feature_width,
       out_feature_height,
