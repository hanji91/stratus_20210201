...
module pw_feature_addr_gen(clk, rstn, stop, start, start_rising, systolic_en, systolic_depth, feature_width, feature_height, feature_channel, out_feature_width, out_feature_height, out_feature_channel, filter_width, filter_height, filter_channel, filter_number, read_feature_base_addr, pw_feature_addr, pw_feature_addr_valid, pw_feature_data_valid, pw_cache_en, pw_feature_data_sel, pw_addr_if_start, systolic_sel_12d);
      ...
      reg[7:0] systolic_sel;
         ...
         // at: pw_feature_addr_gen.h:438:7
         // at: pw_feature_addr_gen.h:434:7
         always @(posedge clk or negedge rstn)
          begin :drive_systolic_sel
            if (rstn == 1'b0) begin
               // op:_systolic_sel_counter/OP333
               systolic_sel <= 8'd000;
            end
            else begin
               // op:_systolic_sel_counter/OP341
         ...
         // at: pw_feature_addr_gen.h:438:42
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:428:46
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:429:75
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:428:84
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:429:45
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_1, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:428:60
         ...
         // at: pw_feature_addr_gen.h:421:7
         // at: pw_feature_addr_gen.h:424:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:413:7
         // at: pw_feature_addr_gen.h:416:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:405:7
         // at: pw_feature_addr_gen.h:408:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:396:7
         // at: pw_feature_addr_gen.h:399:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:276:8
         always @(posedge clk or negedge rstn)
         ...
         // rtl_process:pw_feature_addr_gen/drive_systolic_sel_12d
         // Sharing or Control mux
         // Sharing/Controlling 2 operation(s) on drive_systolic_sel_12d
         // at: pw_feature_addr_gen.h:321:7
         // at: pw_feature_addr_gen.h:374:7
         always @(posedge clk or negedge rstn)
          begin :drive_systolic_sel_12d
            if (rstn == 1'b0) begin
               // op:_delay/OP142
               systolic_sel_12d <= 8'd000;
            end
            else begin
               // op:_delay/OP253
               systolic_sel_12d <= systolic_sel_11d;
            end
         end
         ...
         // at: pw_feature_addr_gen.h:424:26
         ...
         // at: pw_feature_addr_gen.h:416:29
         ...
         // at: pw_feature_addr_gen.h:408:31
         // at: pw_feature_addr_gen.h:327:7
         // at: pw_feature_addr_gen.h:380:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:399:21
         ...
         // at: pw_feature_addr_gen.h:391:31
         ...
         // at: pw_feature_addr_gen.h:337:16
         always @(posedge clk or negedge rstn)
          begin :drive_run_6d
            if (rstn == 1'b0) begin
               // op:_delay/OP105
         ...
         // at: pw_feature_addr_gen.h:338:16
         always @(posedge clk or negedge rstn)
          begin :drive_run_7d
            if (rstn == 1'b0) begin
               // op:_delay/OP106
         ...
         // at: pw_feature_addr_gen.h:339:16
         always @(posedge clk or negedge rstn)
          begin :drive_run_8d
            if (rstn == 1'b0) begin
               // op:_delay/OP107
         ...
         // at: pw_feature_addr_gen.h:340:17
         always @(posedge clk or negedge rstn)
          begin :drive_run_9d
            if (rstn == 1'b0) begin
               // op:_delay/OP108
         ...
         // at: pw_feature_addr_gen.h:347:19
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:348:19
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:349:19
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:350:20
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:357:21
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:358:21
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:359:21
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:359:7
         // at: pw_feature_addr_gen.h:360:22
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:361:22
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:254:49
         ...
         // at: pw_feature_addr_gen.h:369:25
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:370:25
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:371:25
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:372:26
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:373:26
         always @(posedge clk or negedge rstn)
         ...
         // Sharing or Control mux
         // Sharing/Controlling 4 operation(s) on drive_systolic_sel_11d
         // at: pw_feature_addr_gen.h:320:7
         // at: pw_feature_addr_gen.h:373:7
         // at: pw_feature_addr_gen.h:374:26
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:377:34
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:377:7
         // at: pw_feature_addr_gen.h:378:34
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:325:7
         // at: pw_feature_addr_gen.h:378:7
         // at: pw_feature_addr_gen.h:379:34
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:326:7
         // at: pw_feature_addr_gen.h:379:7
         // at: pw_feature_addr_gen.h:380:34
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:273:7
         always @(posedge clk or negedge rstn)
         ...
         // at: pw_feature_addr_gen.h:273:25
         // at: pw_feature_addr_gen.h:262:7
         // at: pw_feature_addr_gen.h:265:7
         always @(posedge clk or negedge rstn)
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:265:43
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:265:75
         ...
         // at: pw_feature_addr_gen.h:265:77
         // at: pw_feature_addr_gen.h:248:7
         // at: pw_feature_addr_gen.h:254:7
         always @(posedge clk or negedge rstn)
          begin :drive_sum_sys
            if (rstn == 1'b0) begin
               // op:_sum_pos/OP34
         ...
         // at: pw_feature_addr_gen.h:265:61
         // at: pw_feature_addr_gen.h:247:7
         // at: pw_feature_addr_gen.h:253:7
         always @(posedge clk or negedge rstn)
          begin :drive_sum_oy
            if (rstn == 1'b0) begin
               // op:_sum_pos/OP33
         ...
         // at: pw_feature_addr_gen.h:265:45
         ...
         // at: pw_feature_addr_gen.h:265:29
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:254:47
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:253:30
         ...
         // Resource=pw_feature_addr_gen_Mul_16Ux16U_32U_1, Function=mul : Inputs=16,16 Outputs=32
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:251:33
         ...
         // at: pw_feature_addr_gen.h:253:16
         // at: pw_feature_addr_gen.h:237:7
         // at: pw_feature_addr_gen.h:239:7
         always @(posedge clk or negedge rstn)
          begin :drive_oy_pos
            if (rstn == 1'b0) begin
               // op:_oy_pos/OP55
         ...
         // at: pw_feature_addr_gen.h:252:16
         // at: pw_feature_addr_gen.h:230:7
         // at: pw_feature_addr_gen.h:232:7
         always @(posedge clk or negedge rstn)
          begin :drive_ox_pos
            if (rstn == 1'b0) begin
               // op:_ox_pos/OP58
         ...
         // at: pw_feature_addr_gen.h:208:39
         // at: pw_feature_addr_gen.h:213:7
         // at: pw_feature_addr_gen.h:218:7
         always @(posedge clk or negedge rstn)
          begin :drive_of_cnt
            if (rstn == 1'b0) begin
               // op:_of_counter/OP416
               of_cnt <= 16'd00000;
            end
            else begin
               // op:_of_counter/OP423
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:208:53
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_1, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:208:35
         ...
         // at: pw_feature_addr_gen.h:202:7
         // at: pw_feature_addr_gen.h:198:7
         always @(posedge clk or negedge rstn)
          begin :drive_oy_cnt
            if (rstn == 1'b0) begin
               // op:_oy_counter/OP391
               oy_cnt <= 16'd00000;
            end
            else begin
               // op:_oy_counter/OP398
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:193:53
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_1, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:193:35
         ...
         // at: pw_feature_addr_gen.h:188:7
         // at: pw_feature_addr_gen.h:184:7
         always @(posedge clk or negedge rstn)
          begin :drive_ox_cnt
            if (rstn == 1'b0) begin
               // op:_ox_counter/OP362
               ox_cnt <= 16'd00000;
            end
            else begin
               // op:_ox_counter/OP371
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:188:30
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:179:53
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_1, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:179:35
         ...
         // at: pw_feature_addr_gen.h:174:7
         // at: pw_feature_addr_gen.h:170:7
         // at: pw_feature_addr_gen.h:429:49
         always @(posedge clk or negedge rstn)
          begin :drive_if_cnt
            if (rstn == 1'b0) begin
               // op:_if_counter/OP296
               if_cnt <= 16'd00000;
            end
            else begin
               // op:_if_counter/OP303
         ...
         // Resource=pw_feature_addr_gen_EqSubi1u16u16_1, Function=sub eq : Inputs=16,16 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:165:53
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_1, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:165:35
         ...
         // at: pw_feature_addr_gen.h:251:35
         ...
         // at: pw_feature_addr_gen.h:159:5
         always @(posedge clk)
         ...
         // at: pw_feature_addr_gen.h:253:32
         // at: pw_feature_addr_gen.h:154:5
         // at: pw_feature_addr_gen.h:179:56
         always @(posedge clk)
         ...
         // at: pw_feature_addr_gen.h:156:5
         // at: pw_feature_addr_gen.h:208:56
         always @(posedge clk)
         ...
         // at: pw_feature_addr_gen.h:193:56
         always @(posedge clk)
         ...
         // at: pw_feature_addr_gen.h:165:56
         always @(posedge clk)
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:157:33
         ...
         // at: pw_feature_addr_gen.h:164:5
         // at: pw_feature_addr_gen.h:173:14
         // at: pw_feature_addr_gen.h:429:27
         // at: pw_feature_addr_gen.h:144:7
         // at: pw_feature_addr_gen.h:148:7
         // at: pw_feature_addr_gen.h:164:17
         // at: pw_feature_addr_gen.h:331:16
         // at: pw_feature_addr_gen.h:428:49
         always @(posedge clk or negedge rstn)
          begin :drive_run
            if (rstn == 1'b0) begin
               // op:_run/OP79
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:145:10
         ...
         // at: pw_feature_addr_gen.h:148:13
         // at: pw_feature_addr_gen.h:135:7
         // at: pw_feature_addr_gen.h:139:7
         always @(posedge clk or negedge rstn)
          begin :drive_enable
            if (rstn == 1'b0) begin
               // op:_enable/OP436
         ...
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:136:62
         ...
         // Resource=pw_feature_addr_gen_Not_1U_1U_4, Function=not : Inputs=1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:138:10
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_4, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:136:39
         ...
         // Resource=pw_feature_addr_gen_Eqi1u16_4, Function=eq : Inputs=16 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:136:91
         ...
         // Resource=pw_feature_addr_gen_And_1Ux1U_1U_4, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         // at: pw_feature_addr_gen.h:136:67
         ...
         // at: pw_feature_addr_gen.h:130:68
