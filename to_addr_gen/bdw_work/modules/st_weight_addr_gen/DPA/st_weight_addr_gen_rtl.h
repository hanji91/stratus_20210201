...
struct st_weight_addr_gen : public sc_module {
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_MuxAdd2i1u16u16u1_1_22_out1;
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_MuxAdd2i1u16u16u1_1_26_out1;
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_MuxAdd2i1u16u16u1_1_30_out1;
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_MuxAdd2i1u16u16u1_1_34_out1;
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_MuxAdd2i32u16u16u1_1_38_out1;
  ...
  sc_signal<sc_uint<32> > st_weight_addr_gen_Add_32Ux16U_32U_4_13_out1;
  sc_signal<sc_uint<32> > st_weight_addr_gen_Mul_16Ux16U_32U_1_12_out1;
  sc_signal<sc_uint<32> > st_weight_addr_gen_Mul_16Ux16U_32U_1_11_out1;
  sc_signal<sc_uint<32> > st_weight_addr_gen_Mul_16Ux16U_32U_1_10_out1;
  sc_signal<sc_uint<32> > org_of_pos;
  sc_signal<sc_uint<32> > org_if_pos;
  sc_signal<sc_uint<32> > st_weight_addr_gen_Add_32Ux32U_32U_1_8_out1;
  sc_signal<sc_uint<32> > org_iy_pos;
  sc_signal<sc_uint<32> > org_ix_pos;
  sc_signal<sc_uint<32> > st_weight_addr_gen_Add3u32u32u32_1_9_out1;
  sc_signal<sc_uint<32> > tmp_st_weight_addr;
  sc_signal<bool > st_weight_addr_valid_4d;
  sc_signal<bool > st_weight_addr_valid_3d;
  sc_signal<bool > st_weight_addr_valid_2d;
  sc_signal<bool > st_weight_addr_valid_1d;
  ...
  sc_signal<bool > st_weight_addr_valid_5d;
  sc_signal<sc_uint<1> > run_3d;
  sc_signal<sc_uint<1> > run_10d;
  sc_signal<bool > st_weight_addr_valid_6d;
  ...
  sc_signal<sc_uint<16> > st_weight_addr_gen_N_Mux_16_3_21_4_2_out1;
  sc_signal<sc_uint<15> > st_weight_addr_gen_N_Mux_16_3_21_4_2_in2;
  sc_signal<sc_uint<14> > st_weight_addr_gen_N_Mux_16_3_21_4_2_in3;
  sc_signal<sc_uint<16> > ox_cnt_max;
  sc_signal<sc_uint<16> > st_weight_addr_gen_N_Mux_16_3_21_4_1_out1;
  sc_signal<sc_uint<15> > st_weight_addr_gen_N_Mux_16_3_21_4_1_in2;
  sc_signal<sc_uint<14> > st_weight_addr_gen_N_Mux_16_3_21_4_1_in3;
  sc_signal<sc_uint<16> > oy_cnt_max;
  sc_signal<sc_uint<16> > st_weight_addr_gen_Add2i1u16_1_3_out1;
  sc_signal<sc_uint<16> > oy_cnt_max2;
  sc_signal<sc_uint<16> > st_weight_addr_gen_Add2i1u16_1_4_out1;
  sc_signal<sc_uint<16> > ox_cnt_max2;
  void drive_ox_cnt_max2();
  void drive_oy_cnt_max2();
  void drive_st_weight_addr_gen_N_Mux_16_3_21_4_1_in3();
  void drive_st_weight_addr_gen_N_Mux_16_3_21_4_1_in2();
  void st_weight_addr_gen_N_Mux_16_3_21_4_1();
  void drive_st_weight_addr_gen_N_Mux_16_3_21_4_2_in3();
  void drive_st_weight_addr_gen_N_Mux_16_3_21_4_2_in2();
  void st_weight_addr_gen_N_Mux_16_3_21_4_2();
  void st_weight_addr_gen_Add2i1u16_1_3();
  void st_weight_addr_gen_Add2i1u16_1_4();
  ...
  void drive_st_weight_addr_valid_6d();
  void drive_run_10d();
  void drive_run_3d();
  void drive_run_1d();
  void drive_run_2d();
  ...
  void drive_run_8d();
  void drive_run_9d();
  void drive_st_weight_addr_valid_1d();
  void drive_st_weight_addr_valid_2d();
  void drive_st_weight_addr_valid_3d();
  void drive_st_weight_addr_valid_4d();
  void drive_st_weight_addr_valid_5d();
  void drive_st_weight_addr();
  void drive_tmp_st_weight_addr();
  void st_weight_addr_gen_Add_32Ux32U_32U_1_8();
  void st_weight_addr_gen_Add3u32u32u32_1_9();
  void drive_org_of_pos();
  void drive_org_if_pos();
  void drive_org_iy_pos();
  void drive_org_ix_pos();
  void st_weight_addr_gen_Mul_16Ux16U_32U_1_10();
  void st_weight_addr_gen_Mul_16Ux16U_32U_1_11();
  void st_weight_addr_gen_Mul_16Ux16U_32U_1_12();
  void st_weight_addr_gen_Add_32Ux16U_32U_4_13();
  void drive_of_pos_slice();
  void drive_if_pos();
  void drive_iy_pos();
  void drive_ix_pos();
  void drive_of_cnt();
  void st_weight_addr_gen_MuxAdd2i32u16u16u1_1_38();
  ...
  void drive_oy_cnt();
  void st_weight_addr_gen_MuxAdd2i1u16u16u1_1_34();
  ...
  void drive_ox_cnt();
  void st_weight_addr_gen_MuxAdd2i1u16u16u1_1_30();
  ...
  void drive_if_cnt();
  void st_weight_addr_gen_MuxAdd2i1u16u16u1_1_26();
  ...
  void drive_iy_cnt();
  void st_weight_addr_gen_MuxAdd2i1u16u16u1_1_22();
