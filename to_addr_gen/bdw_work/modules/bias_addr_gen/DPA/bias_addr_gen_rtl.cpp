...
bias_addr_gen::bias_addr_gen(sc_module_name name) : sc_module(name) 
    ...
    ,bias_addr_gen_MuxAdd2i1u16u16u1_1_16_out1("bias_addr_gen_MuxAdd2i1u16u16u1_1_16_out1")
    ...
    ,bias_addr_gen_MuxAdd2i1u16u16u1_1_21_out1("bias_addr_gen_MuxAdd2i1u16u16u1_1_21_out1")
    ...
    ,bias_addr_gen_Add_32Ux14U_32U_1_3_out1("bias_addr_gen_Add_32Ux14U_32U_1_3_out1")
    ,bias_addr_gen_Add_32Ux14U_32U_1_3_in1("bias_addr_gen_Add_32Ux14U_32U_1_3_in1")
    ,of_cnt("of_cnt")
    ...
    ,bias_addr_gen_And_1Ux1U_1U_4_2_out1("bias_addr_gen_And_1Ux1U_1U_4_2_out1")
{
  ...
  SC_METHOD(drive_bias_addr_gen_Add_32Ux14U_32U_1_3_in1);
  sensitive << ( of_cnt );

  SC_METHOD(bias_addr_gen_Add_32Ux14U_32U_1_3);
  sensitive << ( bias_addr_gen_Add_32Ux14U_32U_1_3_in1 );
  sensitive << ( bias_read_base_addr );

  SC_METHOD(bias_addr_gen_N_Mux_32_2_12_4_4);
  sensitive << ( bias_en );
  sensitive << ( bias_addr_gen_Add_32Ux14U_32U_1_3_out1 );
  sensitive << ( bias_addr );
  ...
  SC_METHOD(bias_addr_gen_MuxAdd2i1u16u16u1_1_21);
  ...
  sensitive << ( bias_addr_gen_MuxAdd2i1u16u16u1_1_21_out1 );
  ...
  SC_METHOD(bias_addr_gen_MuxAdd2i1u16u16u1_1_16);
  ...
  sensitive << ( bias_addr_gen_MuxAdd2i1u16u16u1_1_16_out1 );
...
void bias_addr_gen::drive_bias_addr_gen_Add_32Ux14U_32U_1_3_in1(){
  bias_addr_gen_Add_32Ux14U_32U_1_3_in1 = (sc_uint<14> ) (of_cnt.read().range(15
                                          ,2));
}
// resource: bias_addr_gen_Add_32Ux14U_32U_1  instance: bias_addr_gen_Add_32Ux14U_32U_1_3
void bias_addr_gen::bias_addr_gen_Add_32Ux14U_32U_1_3(){
  bias_addr_gen_Add_32Ux14U_32U_1_3_out1 = (bias_read_base_addr.read() + 
                                           bias_addr_gen_Add_32Ux14U_32U_1_3_in1
                                           .read());
}
...
// resource: bias_addr_gen_MuxAdd2i1u16u16u1_1
void bias_addr_gen::bias_addr_gen_MuxAdd2i1u16u16u1_1_21(){
  if ( bias_addr_gen_And_1Ux1U_1U_1_14_out1.read() ) {
    bias_addr_gen_MuxAdd2i1u16u16u1_1_21_out1 = (of_cnt.read() + 1ULL);
  } else {
    bias_addr_gen_MuxAdd2i1u16u16u1_1_21_out1 = of_cnt.read();
  }
}
...
// resource: bias_addr_gen_MuxAdd2i1u16u16u1_1
void bias_addr_gen::bias_addr_gen_MuxAdd2i1u16u16u1_1_16(){
  if ( bias_addr_gen_And_1Ux1U_1U_1_8_out1.read() ) {
    bias_addr_gen_MuxAdd2i1u16u16u1_1_16_out1 = (oy_cnt.read() + 1ULL);
  } else {
    bias_addr_gen_MuxAdd2i1u16u16u1_1_16_out1 = oy_cnt.read();
  }
}
// resource: bias_addr_gen_Muxi0u16u1_4
