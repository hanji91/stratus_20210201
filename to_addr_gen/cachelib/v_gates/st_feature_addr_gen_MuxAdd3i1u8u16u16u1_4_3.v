...
// Generated on: Jan 18 2021 16:23:41 KST (Jan 18 2021 07:23:41 UTC)

module st_feature_addr_gen_MuxAdd3i1u8u16u16u1_4_3(in4, in3, in2, ctrl1,
     out1);
  input [15:0] in4, in3;
  input [7:0] in2;
  input ctrl1;
  ...
  XNOR2X1 addinc_add_31_2_g205(.A (in3[15]), .B (addinc_add_31_2_n_28),
       .Y (n_15));
  XNOR2X1 addinc_add_31_2_g206(.A (in3[14]), .B (addinc_add_31_2_n_26),
       .Y (n_14));
  NAND2BX1 addinc_add_31_2_g207(.AN (addinc_add_31_2_n_26), .B
       (in3[14]), .Y (addinc_add_31_2_n_28));
  XNOR2X1 addinc_add_31_2_g208(.A (in3[13]), .B (addinc_add_31_2_n_24),
       .Y (n_13));
  NAND2BX1 addinc_add_31_2_g209(.AN (addinc_add_31_2_n_24), .B
       (in3[13]), .Y (addinc_add_31_2_n_26));
  XNOR2X1 addinc_add_31_2_g210(.A (in3[12]), .B (addinc_add_31_2_n_22),
       .Y (n_12));
  NAND2BX1 addinc_add_31_2_g211(.AN (addinc_add_31_2_n_22), .B
       (in3[12]), .Y (addinc_add_31_2_n_24));
  XNOR2X1 addinc_add_31_2_g212(.A (in3[11]), .B (addinc_add_31_2_n_20),
       .Y (n_11));
  NAND2BX1 addinc_add_31_2_g213(.AN (addinc_add_31_2_n_20), .B
       (in3[11]), .Y (addinc_add_31_2_n_22));
  XNOR2X1 addinc_add_31_2_g214(.A (in3[10]), .B (addinc_add_31_2_n_18),
       .Y (n_10));
  NAND2BX1 addinc_add_31_2_g215(.AN (addinc_add_31_2_n_18), .B
       (in3[10]), .Y (addinc_add_31_2_n_20));
  XNOR2X1 addinc_add_31_2_g216(.A (in3[9]), .B (addinc_add_31_2_n_16),
       .Y (n_9));
  NAND2BX1 addinc_add_31_2_g217(.AN (addinc_add_31_2_n_16), .B
       (in3[9]), .Y (addinc_add_31_2_n_18));
  XOR2XL addinc_add_31_2_g218(.A (in3[8]), .B (addinc_add_31_2_n_15),
       .Y (n_8));
  NAND2X1 addinc_add_31_2_g219(.A (in3[8]), .B (addinc_add_31_2_n_15),
       .Y (addinc_add_31_2_n_16));
  ADDFX1 addinc_add_31_2_g220(.A (addinc_add_31_2_n_12), .B (in2[7]),
       .CI (in3[7]), .CO (addinc_add_31_2_n_15), .S (n_7));
  ADDFX1 addinc_add_31_2_g221(.A (addinc_add_31_2_n_10), .B (in2[6]),
       .CI (in3[6]), .CO (addinc_add_31_2_n_12), .S (n_6));
  ADDFX1 addinc_add_31_2_g222(.A (addinc_add_31_2_n_8), .B (in2[5]),
       .CI (in3[5]), .CO (addinc_add_31_2_n_10), .S (n_5));
  ADDFX1 addinc_add_31_2_g223(.A (addinc_add_31_2_n_6), .B (in2[4]),
       .CI (in3[4]), .CO (addinc_add_31_2_n_8), .S (n_4));
  ADDFX1 addinc_add_31_2_g224(.A (addinc_add_31_2_n_4), .B (in2[3]),
       .CI (in3[3]), .CO (addinc_add_31_2_n_6), .S (n_3));
  ADDFX1 addinc_add_31_2_g225(.A (addinc_add_31_2_n_2), .B (in2[2]),
       .CI (in3[2]), .CO (addinc_add_31_2_n_4), .S (n_2));
  ADDFX1 addinc_add_31_2_g226(.A (addinc_add_31_2_n_0), .B (in2[1]),
       .CI (in3[1]), .CO (addinc_add_31_2_n_2), .S (n_1));
  XNOR2X1 addinc_add_31_2_g227(.A (in3[0]), .B (in2[0]), .Y (n_0));
  OR2X1 addinc_add_31_2_g228(.A (in3[0]), .B (in2[0]), .Y
       (addinc_add_31_2_n_0));
endmodule
