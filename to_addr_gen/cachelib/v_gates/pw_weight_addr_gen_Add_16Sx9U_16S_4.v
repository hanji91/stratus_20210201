...
// Generated on: Jan 21 2021 20:35:47 KST (Jan 21 2021 11:35:47 UTC)

module pw_weight_addr_gen_Add_16Sx9U_16S_4(in2, in1, out1);
  input [15:0] in2;
  input [8:0] in1;
  output [15:0] out1;
  wire [15:0] in2;
  ...
  AOI31X1 add_23_2_g501(.A0 (add_23_2_n_20), .A1 (add_23_2_n_25), .A2
       (add_23_2_n_37), .B0 (add_23_2_n_14), .Y (add_23_2_n_41));
  AOI21X1 add_23_2_g502(.A0 (add_23_2_n_20), .A1 (add_23_2_n_37), .B0
       (add_23_2_n_26), .Y (add_23_2_n_40));
  OAI21X1 add_23_2_g503(.A0 (add_23_2_n_2), .A1 (add_23_2_n_36), .B0
       (add_23_2_n_13), .Y (add_23_2_n_39));
  XNOR2X1 add_23_2_g504(.A (add_23_2_n_21), .B (add_23_2_n_37), .Y
       (out1[4]));
  INVX1 add_23_2_g505(.A (add_23_2_n_37), .Y (add_23_2_n_36));
  ...
  NOR2BX1 add_23_2_g518(.AN (in2[9]), .B (add_23_2_n_3), .Y
       (add_23_2_n_24));
  NAND2BX1 add_23_2_g519(.AN (add_23_2_n_2), .B (add_23_2_n_13), .Y
       (add_23_2_n_21));
