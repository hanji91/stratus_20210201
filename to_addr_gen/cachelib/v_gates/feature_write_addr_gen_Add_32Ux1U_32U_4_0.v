...
// Generated on: Dec 15 2020 18:41:52 KST (Dec 15 2020 09:41:52 UTC)

module feature_write_addr_gen_Add_32Ux1U_32U_4_0(in2, in1, out1);
  input [31:0] in2;
  input in1;
  output [31:0] out1;
  wire [31:0] in2;
  ...
  wire inc_add_23_2_n_8, inc_add_23_2_n_9, inc_add_23_2_n_10,
       inc_add_23_2_n_11, inc_add_23_2_n_13, inc_add_23_2_n_14,
       inc_add_23_2_n_15, inc_add_23_2_n_17;
  ...
  NAND4XL inc_add_23_2_g316(.A (in2[27]), .B (in2[26]), .C
       (inc_add_23_2_n_6), .D (inc_add_23_2_n_48), .Y
       (inc_add_23_2_n_57));
  ...
  XNOR2X1 inc_add_23_2_g318(.A (in2[17]), .B (inc_add_23_2_n_1), .Y
       (out1[17]));
  NOR2BX1 inc_add_23_2_g319(.AN (inc_add_23_2_n_6), .B
  ...
  INVX1 inc_add_23_2_g324(.A (inc_add_23_2_n_49), .Y
       (inc_add_23_2_n_48));
  NAND4XL inc_add_23_2_g325(.A (in2[22]), .B (inc_add_23_2_n_10), .C
  ...
  XOR2XL inc_add_23_2_g329(.A (in2[18]), .B (inc_add_23_2_n_38), .Y
       (out1[18]));
  NAND2X1 inc_add_23_2_g330(.A (inc_add_23_2_n_10), .B
  ...
  XNOR2X1 inc_add_23_2_g334(.A (in2[9]), .B (inc_add_23_2_n_0), .Y
       (out1[9]));
  NOR2X1 inc_add_23_2_g337(.A (inc_add_23_2_n_11), .B
  ...
  NAND2BX1 inc_add_23_2_g341(.AN (inc_add_23_2_n_30), .B (in2[14]), .Y
       (inc_add_23_2_n_35));
  NAND4XL inc_add_23_2_g343(.A (in2[14]), .B (inc_add_23_2_n_9), .C
  ...
  XOR2XL inc_add_23_2_g346(.A (in2[10]), .B (inc_add_23_2_n_26), .Y
       (out1[10]));
  NAND2X1 inc_add_23_2_g347(.A (inc_add_23_2_n_9), .B
  ...
  XNOR2X1 inc_add_23_2_g350(.A (in2[8]), .B (inc_add_23_2_n_22), .Y
       (out1[8]));
  NOR2X1 inc_add_23_2_g352(.A (inc_add_23_2_n_8), .B
  ...
  XNOR2X1 inc_add_23_2_g363(.A (in2[3]), .B (inc_add_23_2_n_17), .Y
       (out1[3]));
  NAND3BXL inc_add_23_2_g364(.AN (inc_add_23_2_n_15), .B (in2[3]), .C
       (in2[2]), .Y (inc_add_23_2_n_19));
  XNOR2X1 inc_add_23_2_g365(.A (in2[2]), .B (inc_add_23_2_n_15), .Y
       (out1[2]));
  NAND2BX1 inc_add_23_2_g366(.AN (inc_add_23_2_n_15), .B (in2[2]), .Y
       (inc_add_23_2_n_17));
  XNOR2X1 inc_add_23_2_g367(.A (in2[1]), .B (inc_add_23_2_n_5), .Y
       (out1[1]));
  NAND2BX1 inc_add_23_2_g368(.AN (inc_add_23_2_n_5), .B (in2[1]), .Y
       (inc_add_23_2_n_15));
  NAND3BXL inc_add_23_2_g369(.AN (inc_add_23_2_n_8), .B (in2[11]), .C
       (in2[10]), .Y (inc_add_23_2_n_14));
  NAND3BXL inc_add_23_2_g370(.AN (inc_add_23_2_n_11), .B (in2[19]), .C
       (in2[18]), .Y (inc_add_23_2_n_13));
  XOR2XL inc_add_23_2_g371(.A (in2[0]), .B (in1), .Y (out1[0]));
  NAND2X1 inc_add_23_2_g372(.A (in2[17]), .B (in2[16]), .Y
       (inc_add_23_2_n_11));
  AND2XL inc_add_23_2_g373(.A (in2[21]), .B (in2[20]), .Y
       (inc_add_23_2_n_10));
  AND2XL inc_add_23_2_g374(.A (in2[13]), .B (in2[12]), .Y
       (inc_add_23_2_n_9));
  NAND2X1 inc_add_23_2_g375(.A (in2[9]), .B (in2[8]), .Y
       (inc_add_23_2_n_8));
  NAND2X1 inc_add_23_2_g376(.A (in2[5]), .B (in2[4]), .Y
       (inc_add_23_2_n_7));
  AND2XL inc_add_23_2_g377(.A (in2[25]), .B (in2[24]), .Y
       (inc_add_23_2_n_6));
  NAND2X1 inc_add_23_2_g378(.A (in2[0]), .B (in1), .Y
       (inc_add_23_2_n_5));
  NOR2X1 inc_add_23_2_g379(.A (inc_add_23_2_n_7), .B
       (inc_add_23_2_n_19), .Y (inc_add_23_2_n_4));
  NOR2X1 inc_add_23_2_g380(.A (inc_add_23_2_n_14), .B
       (inc_add_23_2_n_22), .Y (inc_add_23_2_n_3));
  NOR2X1 inc_add_23_2_g381(.A (inc_add_23_2_n_13), .B
       (inc_add_23_2_n_34), .Y (inc_add_23_2_n_2));
  NAND2BX1 inc_add_23_2_g2(.AN (inc_add_23_2_n_34), .B (in2[16]), .Y
       (inc_add_23_2_n_1));
  NAND2BX1 inc_add_23_2_g382(.AN (inc_add_23_2_n_22), .B (in2[8]), .Y
       (inc_add_23_2_n_0));
endmodule
