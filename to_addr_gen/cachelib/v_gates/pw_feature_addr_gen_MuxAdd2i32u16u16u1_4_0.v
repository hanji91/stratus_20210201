...
module pw_feature_addr_gen_MuxAdd2i32u16u16u1_4_0(in3, in2, ctrl1, out1);
  input [15:0] in3, in2;
  input ctrl1;
  output [15:0] out1;
  wire [15:0] in3, in2;
  ...
  MX2XL g173(.A (n_8), .B (in3[6]), .S0 (n_0), .Y (out1[6]));
  MX2XL g174(.A (in3[15]), .B (n_17), .S0 (ctrl1), .Y (out1[15]));
  MX2XL g175(.A (in3[14]), .B (n_16), .S0 (ctrl1), .Y (out1[14]));
  MX2XL g176(.A (n_9), .B (in3[7]), .S0 (n_0), .Y (out1[7]));
  MX2XL g177(.A (n_12), .B (in3[10]), .S0 (n_0), .Y (out1[10]));
