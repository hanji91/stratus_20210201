...
// Generated on: Dec  8 2020 00:26:52 KST (Dec  7 2020 15:26:52 UTC)

module st_weight_addr_gen_MuxAdd2i1u16u16u1_4_10(in3, in2, ctrl1, out1);
  input [15:0] in3, in2;
  input ctrl1;
  output [15:0] out1;
  wire [15:0] in3, in2;
  ...
  MX2XL g172(.A (in3[10]), .B (n_11), .S0 (ctrl1), .Y (out1[10]));
  MX2XL g173(.A (n_7), .B (in3[6]), .S0 (n_0), .Y (out1[6]));
  MX2XL g174(.A (n_15), .B (in3[14]), .S0 (n_0), .Y (out1[14]));
  MX2XL g175(.A (n_14), .B (in3[13]), .S0 (n_0), .Y (out1[13]));
